...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6  dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col  rounded-lg lg:max-w-4xl lg:flex-row">
                <div
                ...
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Inregistreaza-te cu o adresa de email.
                            </span>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <span>
                                Alege-ti simbolurile de interes.
                            </span>
                        </li>
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:bottom-1/2 before:left-[0.4rem] before:top-0 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        ...
                        <template v-else>
                            <li>
                                <Link
                                    :href="route('login')"
                                    class="inline-block rounded-sm border border-transparent bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white"
                                >
                                    Intra in cont
                                </Link>
                            </li>
                ...
                <div
                    class="relative -mb-px  w-full shrink-0  rounded-t-lg  lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg"
                >
                    <Table>
                        <TableHeader>
                            <TableRow>
                        ...
                        <TableBody>
                            <TableRow v-for="rate in props.rates" :key="rate.currency">
                                <TableCell>
                                    <div class="">
